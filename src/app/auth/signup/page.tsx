    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#0a0a0f' }}>
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm" style={{ color: '#8888a0' }}>Account aanmaken</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="name" className="block text-sm font-medium" style={{ color: '#f0f0f5' }}>
              Naam
            </label>
            <input
              id="name"
              ...
              style={{ backgroundColor: '#12121a', border: '1px solid #1a1a2e', color: '#f0f0f5' }}
              placeholder="Stef"
            />
          </div>
        ...
        <p className="text-center text-sm" style={{ color: '#8888a0' }}>
          Al een account?{' '}
          <Link href="/auth/login" style={{ color: '#4f8cff' }} className="hover:underline">
            Inloggen
          </Link>
        </p>
      </div>
