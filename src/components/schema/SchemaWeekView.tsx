    ...
    <div className="flex flex-col gap-3">
      ...
      {[1, 2, 3, 4].map((i) => (
        <SkeletonCard key={i} className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-full bg-bg-subtle shrink-0" />
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {calendarConnected ? (
            <button
              ...
              className="flex shrink-0 items-center gap-1.5 rounded-xl bg-accent px-3 py-1.5 text-xs font-medium text-accent-text"
            >
              <Calendar size={13} />
              Plan in agenda
            </button>
            ...
            <a
              href="/settings"
              className="shrink-0 text-xs text-text-tertiary underline-offset-2 hover:underline"
            >
              Koppel agenda
            </a>
          )}
