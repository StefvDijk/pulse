...
function MemoryItem({
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1 rounded-lg px-2 py-1 text-xs text-text-secondary hover:bg-bg-hover"
            >
              <X size={12} /> Annuleer
            </button>
            <button
              ...
              className="flex items-center gap-1 rounded-lg bg-accent px-2 py-1 text-xs font-medium text-accent-text disabled:opacity-50"
            >
  ...
  return (
    <div className="group flex items-start gap-2 rounded-lg px-3 py-2 hover:bg-bg-subtle">
        ...
        {confirming ? (
          <>
            <button
              ...
              disabled={saving}
              className="rounded p-1 text-status-red hover:bg-status-red-light disabled:opacity-50"
          ...
          <>
            ...
            <button
              ...
              className="rounded p-1 text-text-tertiary hover:bg-bg-hover hover:text-status-red"
              title="Verwijder"
            >
              <Trash2 size={14} />
            </button>
    ...
    <div className="bg-bg-card border border-border-light rounded-[14px] p-[14px_16px]">
      ...
      {isLoading ? (
        <div className="flex flex-col gap-2">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-10 animate-pulse rounded-lg bg-bg-subtle" />
          ))}
        </div>
      ) : memories.length === 0 ? (
