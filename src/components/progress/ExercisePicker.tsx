  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-xl border border-border-light bg-bg-card px-4 py-3 text-left transition-colors hover:bg-bg-hover"
      >
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute left-0 right-0 top-full z-50 mt-1 rounded-xl border border-border-light bg-bg-card shadow-lg overflow-hidden">
          {/* Search */}
              ...
              filtered.map((exercise) => (
                <button
                  ...
                  className={`flex w-full items-center justify-between px-4 py-2.5 text-left transition-colors hover:bg-bg-hover ${
                    exercise.name === selected ? 'bg-bg-subtle' : ''
                  }`}
                >
