      ...
      <div className="mt-2 flex flex-wrap gap-2">
        {item.requires_response && item.type === 'coach_question' && (
          <button
            ...
            className="min-h-11 rounded-full bg-[#D97757] px-3 py-2 text-xs text-white hover:opacity-90 disabled:opacity-50"
          >
        ...
        {isUnread && (
          <button
            ...
            disabled={busy}
            onClick={() => patch('read')}
            className="min-h-11 rounded-full bg-white/5 px-3 py-2 text-xs text-white/80 hover:bg-white/10 disabled:opacity-50"
          >
            Markeer gelezen
          </button>
        )}
        <button
          ...
          className="min-h-11 rounded-full bg-white/5 px-3 py-2 text-xs text-white/60 hover:bg-white/10 disabled:opacity-50"
        >
          Negeren
        </button>
      </div>
      {answering && (
        <div className="mt-2">
          ...
          <button
            ...
            className="mt-1 min-h-11 rounded-full bg-[#D97757] px-3 py-2 text-xs text-white disabled:opacity-50"
          >
            Versturen
          </button>
        </div>
